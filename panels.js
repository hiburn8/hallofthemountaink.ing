...
{
  location: 'Bunker NEEDS ROTATING SHAPES',
  level: '43',
  theme: 'grey',
  gridSizeX: 4,
  gridSizeY: 4,
  puzzles: [
    { x: 0, y: 2, value: 'tetromino_T' } //TODO: should be tetromino_T_R270+
    ],
  blockedLines: [],
  hiddenLines: [],
  hexagons: [
...
{
  location: 'Castle NEEDS ROTATING SHAPES and multi-end',
  level: '56',
  theme: 'green',
  gridSizeX: 4,
  gridSizeY: 4,
  puzzles: [
    { x: 2, y: 0, value: 'tetromino_L_FH_R90' }, // TODO should be tetromino_L_FH_R90+
    { x: 1, y: 3, value: 'tetromino_L_FH_R90' }, // TODO should be tetromino_L_FH_R90+
    ],
  blockedLines: [],
  hiddenLines: [],
  hexagons: [],
...
},
{
  ...
  gridSizeY: 3,
  puzzles: [
    { x: 1, y: 2, value: 'domino_Skew' },
    { x: 2, y: 2, value: 'domino_Skew_R90' },
    ],
  blockedLines: [],
  hiddenLines: [],
  hexagons: [],
